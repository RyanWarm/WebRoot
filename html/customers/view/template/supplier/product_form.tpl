  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <input type="hidden" name="product_supplier[supplier_id]" value="<?php echo $product_supplier['supplier_id']; ?>" />
          ...
          <div id="language<?php echo $language['language_id']; ?>" >
            <table class="form">
              <tr>
                ...
                <td><?php echo $product_description[$language['language_id']]['name']; ?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td>库存数量</td>
                <td><input type="text" name="product_supplier[quantity]" value="<?php echo $product_supplier['quantity']; ?>" />（包含已预定产品数量）</td>
              </tr>
              <tr>
                <td>已预定产品数量</td>
                <td><?php echo $product_supplier['hold_quantity']; ?><input type="hidden" name="product_supplier[hold_quantity]" value="<?php echo $product_supplier['hold_quantity']; ?>" /></td>
              </tr>
              <tr>
                <td>已售出产品数量</td>
                <td><?php echo $product_supplier['ordered_quantity']; ?></td>
              </tr>
...
$('input[name=\'related\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=supplier/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
...
function attributeautocomplete(attribute_row) {
	$('input[name=\'product_attribute[' + attribute_row + '][name]\']').catcomplete({
		...
		source: function(request, response) {
			$.ajax({
				url: 'index.php?route=supplier/attribute/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
				dataType: 'json',
				success: function(json) {	
					response($.map(json, function(item) {
						return {
...
$('input[name=\'option\']').catcomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=supplier/option/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
function addImage() {
	...
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][orig_image]" value="" id="image' + image_row + '" /><br /><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
