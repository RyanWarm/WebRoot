...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="form_submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-supplier">供应商</a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <input type="hidden" name="image_updated" id="image_updated" value="0" ></input>
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                <td>副标题</td>
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][sexy_name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['sexy_name'] : ''; ?>" /></td>
              </tr>
              <tr>
                <td>Web版短标题</td>
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][short_name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_name'] : ''; ?>" /></td>
              </tr>
              <tr>
                <td>产品类型</td>
                <td><select name="product_type">
                  <option value="shipping_gift" <?php echo ($product_type == 'shipping_gift')? 'selected="selected"' : ''; ?> >实体商品</option>
                  <option value="lotto" <?php echo ($product_type == 'lotto')? 'selected="selected"' : ''; ?> >彩票</option>
                  <option value="coupons" <?php echo ($product_type == 'coupons')? 'selected="selected"' : ''; ?> >代金券</option>
                </select>
                </td>
              </tr>
              <tr>
                <td><?php echo $entry_review; ?></td>
                <td><textarea rows="10" cols="80" name="product_description[<?php echo $language['language_id']; ?>][review]" id="review<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['review'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_recommend_reason; ?></td>
                <td><textarea rows="10" cols="80" name="product_description[<?php echo $language['language_id']; ?>][recommend_reason]" id="recommend_reason<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['recommend_reason'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea rows="10" cols="80" name="product_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td>优惠券兑换规则</td>
                <td><textarea rows="10" cols="80" name="product_description[<?php echo $language['language_id']; ?>][coupons_rule]" id="coupons_rule<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['coupons_rule'] : ''; ?></textarea></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><?php echo $this->language->get('entry_score'); ?></td>
                <td><input type="text" name="score" value="<?php echo $score; ?>" /></td>
              </tr>
              <tr>
                <td>团送人数</td>
                <td><input type="text" name="group_count" value="<?php echo $group_count; ?>" /></td>
              </tr>
              <tr>
                ...
                <td><div class="image"><img src="<?php echo HTTP_IMAGE  . $orig_image; ?>" alt="" id="thumb" /><br />
                  ...
                  <a onclick="image_upload('image', 'thumb'); g_image_updated=1;"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
              </tr>
              <tr>
                <td>微博活动图片</td>
                <td><div class="image"><img src="<?php echo HTTP_IMAGE  . $feed_image; ?>" alt="" id="feed_image_thumb" /><br />
                  <input type="hidden" name="feed_image" value="<?php echo $feed_image; ?>" id="feed_image" />
                  <a onclick="image_upload('feed_image', 'feed_image_thumb'); g_image_updated=1;"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#feed_image_thumb').attr('src', '<?php echo $no_image; ?>'); $('#feed_image').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
              </tr>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              <td><?php echo $this->language->get('entry_product_group'); ?></td>
              <td><div class="scrollbox" style="width:500px;height:300px">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($product_groups as $group) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?php echo $class; ?>">
                    <?php if (in_array($group['product_group_id'], $product_group)) { ?>
                    <input type="checkbox" name="product_group[]" value="<?php echo $group['product_group_id']; ?>" checked="checked" />
                    <?php echo $group['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="product_group[]" value="<?php echo $group['product_group_id']; ?>" />
                    <?php echo $group['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
        ...
        <div id="tab-supplier">
          <table class="form">
            <tr>
              <td>供应商</td>
              <td><select name="product_supplier[supplier_id]">
                  <option value="0" selected="selected"><?php echo $text_none; ?></option>
                  <?php foreach ($suppliers as $supplier) { ?>
                  <?php if ($supplier['supplier_id'] == $product_supplier[supplier_id]) { ?>
            ...
            <tr>
              <td>产品网址</td>
              <td><input type="text" name="product_supplier[supplier_product_url]" value="<?php echo $product_supplier['supplier_product_url']; ?>" ></input>
              <?php if (!empty($product_supplier['supplier_product_url'])) { ?>
              <span><a target="_blank" href="<?php echo $product_supplier['supplier_product_url']; ?>" >访问</a>
              </span>
</td>         <?php } ?>
            </tr>
            <tr>
              <td>供应商价格</td>
              <td><input type="text" name="product_supplier[supplier_product_price]" value="<?php echo $product_supplier['supplier_product_price']; ?>" ></input>

</td>
            </tr>
            <tr>
              <td>库存产品数量</td>
              <td><input type="text" name="product_supplier[quantity]" value="<?php echo $product_supplier['quantity']; ?>" ></input></td>
            </tr>
            <tr>
              <td>已预定产品数量</td>
              <td><input type="type" name="product_supplier[hold_quantity]" value="<?php echo $product_supplier['hold_quantity']; ?>" readonly="1" style="background: #ddd" ></input></td>
            </tr>
            <tr>
              <td>已售出产品数量</td>
              <td><input type="type" name="product_supplier[ordered_quantity]" value="<?php echo $product_supplier['ordered_quantity']; ?>" readonly="1" style="background: #ddd" > </input></td>
            </tr>
        ...
        <div id="tab-image">
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                <td class="left"><div class="image"><img src="<?php echo HTTP_IMAGE . $product_image['orig_image']; ?>" alt="" id="thumb<?php echo $image_row; ?>" />
                    <input type="hidden" name="product_image[<?php echo $image_row; ?>][orig_image]" value="<?php echo $product_image['orig_image']; ?>" id="image<?php echo $image_row; ?>" />
                    <br />
                    <a onclick="image_upload('image<?php echo $image_row; ?>', 'thumb<?php echo $image_row; ?>'); g_image_updated = 1;"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $image_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
                ...
                <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove(); g_image_updated = 1;" class="button"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addImage();g_image_updated = 1;" class="button"><?php echo $button_add_image; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
<?php } ?>
<?php foreach ($languages as $language) { ?>
CKEDITOR.replace('review2<?php echo $language['language_id']; ?>', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
<?php foreach ($languages as $language) { ?>
CKEDITOR.replace('recommend_reason2<?php echo $language['language_id']; ?>', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	...
	$('#dialog').dialog({
		...
		close: function (event, ui) {
			if ($('#' + field).attr('value')) {
                ...
                $('#' + thumb).replaceWith('<img src="' + '<?php echo HTTP_IMAGE; ?>' + $('#' + field).attr('value') + '" alt="" id="' + thumb + '" />');
/*
				$.ajax({
...
function addImage() {
	...
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][orig_image]" value="" id="image' + image_row + '" /><br /><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');g_image_updated = 1;"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
	html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" size="2" /></td>';
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove(); g_image_updated=1;" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
