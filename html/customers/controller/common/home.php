...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		$this->data['token'] = $this->user->getCookieToken();
	...
	public function login() {
		...
		if (isset($this->request->get['route'])) {
            ...
            */
            if ( !in_array($route, $ignore) && !$this->user->isTokenValid($cookie_token) ) {
                error_log("not login, cookie=" . $cookie_token);
                return $this->forward('common/login');
            }
		} else {
            /*
            ...
            */
            //if ($cookie_token != md5('admin_token')) {
