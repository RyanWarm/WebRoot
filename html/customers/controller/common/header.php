...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_occasion'] = $this->language->get('text_occasion');
		...
		if (!$this->user->isLogged() ) {
			...
			$this->data['account'] = $this->url->link('account/account', null, 'SSL');
            		$this->data['invite_code'] = $this->url->link('account/invite_code', null, 'SSL');
            		$this->data['invite_code_request'] = $this->url->link('account/invite_code_request', null, 'SSL');
			$this->data['linkedin'] = $this->url->link('account/linkedin', null, 'SSL');
			$this->data['contact_request'] = $this->url->link('account/contact_request', null, 'SSL');
			$this->data['company'] = $this->url->link('company/company', null, 'SSL');
			$this->data['job'] = $this->url->link('company/job', null, 'SSL');
            		$this->data['backend_api'] = $this->url->link('monitor/backend_api', null, 'SSL');
