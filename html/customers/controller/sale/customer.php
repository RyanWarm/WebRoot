...
class ControllerSaleCustomer extends Controller { 
	...
	public function approve() {
  	...
  	private function getList() {
        ...
        echo "total_users: " . $customer_total;
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('sale/customer/update', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['id'] . $url, 'SSL')
			);
			
			$this->data['customers'][] = array(
				'customer_id'    => $result['id'],
				'name'           => $result['name'],
				'email'          => $result['profile_id'],
				'customer_group' => $result['network'],
				'status'         => $result['gender'],
				'approved'       => $result['birthday'],
                'image'          => $result['image'],
				'date_added'     => $result['created_at'], #date($this->language->get('date_format_short'), strtotime($result['date_added'])),
		...
		$this->data['male'] = $this->language->get('male');
		$this->data['female'] = $this->language->get('female');
        ...
        $this->data['sort_id'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=u.id' . $url, 'SSL');
		$this->data['sort_name'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=u.name' . $url, 'SSL');
		$this->data['sort_email'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=p.id' . $url, 'SSL');
		$this->data['sort_customer_group'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=p.network' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=p.gender' . $url, 'SSL');
		$this->data['sort_approved'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=p.birthday' . $url, 'SSL');
		$this->data['sort_date_added'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=u.created_at' . $url, 'SSL');
    	...
    	$this->data['customer_groups'] = $this->model_sale_customer->getNetworks();
