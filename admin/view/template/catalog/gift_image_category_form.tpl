            ...
            <tr>
              ...
              <td><div class="scrollbox" style="width:500px;height:300px">
                  ...
                  <div class="<?php echo $class; ?>">
                    <input type="checkbox" name="gift_images[]" value="<?php echo $gift_image['image_id']; ?>" checked="checked" /><?php echo 'ID: '. $gift_image['image_id'] . "&nbsp;:" .  $gift_image['name']; ?>&nbsp;<a href="<?php echo $gift_image['edit_link'] ?>">edit</a>
                  </div>
                  <?php } ?>
                </div>
              </td>
