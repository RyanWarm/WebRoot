          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea rows="15" cols="80" name="category_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
            ...
            <tr>
              ...
              <td><div class="scrollbox" style="width:500px;height:300px">
                  ...
                  <div class="<?php echo $class; ?>">
                    <?php echo '<span>ID: '. $product['product_id'] . "</span>&nbsp;<span>: " .  $product['name']; ?></span>&nbsp;<a href="<?php echo $product['edit_link'] ?>">edit</a>&nbsp;&nbsp;<?php echo $product['status'] ? "<span style='color:#000'>启用</span>":"<span style='color:#ff0000'>停用</span>"; ?><span>
                  </div>
                  <?php } ?>
                </div>
              </td>
