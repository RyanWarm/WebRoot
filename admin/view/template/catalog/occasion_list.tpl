      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($occasion['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $occasion['name']; ?></td>
              <td class="left"><?php echo $occasion['tag_count']; ?></td>
              <td class="right"><?php echo $occasion['sort_order']; ?></td>
              <td class="right"><?php echo $occasion['status']; ?></td>
              <td class="right"><?php foreach ($occasion['action'] as $action) { ?>
