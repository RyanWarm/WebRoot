...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <?php } ?>
      <?php if ($show_confirm_receive_gift) { ?>
        <a onclick="updateOrderStatus('confirm_receive_gift');" class="button">确认收货</a>
      <?php } ?>
      <?php if ($show_cancel_order) { ?>
        <a onclick="updateOrderStatus('cancel_order');" class="button">取消订单</a>
      <?php } ?>
      </div>
    </div>
    <div class="content">      
      <div>
          <table>
            ...
            <tr>
              <td>flavor_product_id</td>
              <td><?php echo $flavor_product_id;?></td>
            </tr>
            ...
            <tr>
              <td>recipient_profile_id</td>
              <td><?php echo $recipient_profile_id;?></td>
            </tr>
            <tr>
              <td>recipient_profile_network</td>
              <td><?php echo $recipient_profile_network;?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>recipient_address_id</td>
              <td><?php echo $recipient_address_id;?></td>
            </tr>

            <tr>
              <td>recipient_notification_date</td>
              <td><?php echo $recipient_notification_date;?></td>
            </tr>
            <tr>
              <td>recipient_shipping_date</td>
              <td><?php echo $recipient_shipping_date;?></td>
            </tr>
            ...
            <tr>
              <td>short_track_code</td>
              <td><?php echo $short_track_code; ?></td>
            </tr>
            <tr>
              <td>pay_track_code</td>
              <td><?php echo $pay_track_code; ?></td>
            </tr>
          </table>
      </div>
      <div id="vtabs" class="vtabs"><a href="#tab-status"><?php echo $lang->get('tab_status'); ?></a><a href="#tab-sender"><?php echo $tab_sender; ?></a><a href="#tab-recipient"><?php echo $tab_recipient; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a><a href="#tab-shipping">物流及地址</a><a href="#tab-card"><?php echo $this->language->get('tab_card'); ?></a><a href="#tab-product"><?php echo $tab_product; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-status" class="vtabs-content">
          <table class="form">
            <tr>
              <td><?php echo $lang->get('entry_status_summary'); ?> </td>
              <td>
                  <?php echo $status_summary; ?>
              </td>
            </tr>
            <tr>
            <table id="order_statuses" class="list" >
            <?php $status_row = 0; ?>
            <?php foreach ($order_statuses as $order_status) { ?>
              ...
              <tr>
                <td><?php echo $lang->get("entry_status"); ?></td>
                <td>
                  <?php 
              ...
              <tr>
                <td><?php echo $lang->get("entry_status_start_time"); ?></td>
                <td><?php echo $order_status['start_time']; ?></td>
              </tr>
              <tr>
                <td><?php echo $lang->get("entry_status_complete_time"); ?></td>
                <td><?php echo $order_status['complete_time']; ?></td>
              </tr>
              <tr>
                <td><?php echo $lang->get("entry_status_complete_reason"); ?></td>
                <td><?php echo $order_status['complete_reason']; ?></td>
              </tr>
              <tr>
                <td><?php echo $lang->get("entry_status_log"); ?></td>
                <td><textarea cols="80" readonly=1 ><?php echo $order_status['log']; ?></textarea></td>
              </tr>
              <!-- tr>
                <td colspan="2"><a onclick="$('#status-row<?php echo $status_row; ?>').remove();" class="button">remove</td>
              </tr -->
              </tbody>
              <?php $status_row++; ?>
            <?php } ?>
        ...
        <div id="tab-sender" class="vtabs-content">
          <table class="form">
            <tr>
              <td><?php echo $this->language->get('entry_sender_id'); ?></td>
              <td><input type="text" readonly="1" name="sender_id" value="<?php echo $sender_id; ?>" />
              </td>
            </tr>
            <tr>
        ...
        <div id="tab-recipient" class="vtabs-content">
          <table class="form">
            <tr>
              <td><?php echo $lang->get('entry_recipient_id'); ?></td>
              <td><input type="text" readonly="1" name="recipient_id" value="<?php echo $recipient_id; ?>" /> 
              <input type="hidden" name="recipient_profile_id" value="<?php echo $recipient_profile_id; ?>" /> 
              <input type="hidden" name="recipient_profile_network" value="<?php echo $recipient_profile_network; ?>" /> 
              </td>
            <tr>
              <td><?php echo $lang->get("entry_recipient_name"); ?></td>
              <td><input type="text" name="recipient_name" value="<?php echo $recipient_name; ?>" />
            </tr>
            <tr>
              <td><?php echo $lang->get("entry_recipient_notification_date"); ?></td>
              <td><input type="text" name="recipient_notification_date" value="<?php echo $recipient_notification_date; ?>" />
            </tr>
            <tr>
              <td><?php echo $lang->get('entry_recipient_notifications'); ?></td>
              <td>
                <table>
                  <?php foreach ($recipient_notifications as $rn) { ?>
                    <tr>
                      <td><?php echo $lang->get("entry_notification_method"); ?></td>
                      <td><?php echo $rn['notification_method']; ?></td>
                    </tr>
                    <tr>
                      <td><?php echo $lang->get("entry_notification_contact"); ?></td>
                      <td><?php echo $rn['notification_contact']; ?></td>
                    </tr>
                    <tr>
                      <td><?php echo $lang->get("entry_notification_content"); ?></td>
                      <td><?php echo $rn['notification_content']; ?></td>
                    </tr>
                  <?php } ?>
                </table>
              </td>
            ...
            <tr>
              <td><?php echo $lang->get("entry_recipient_shipping_date"); ?></td>
              <td><input type="text" name="recipient_shipping_date" value="<?php echo $recipient_shipping_date; ?>" />
            </tr>
            <tr>
              <td>感谢信</td>
              <td><textarea name="thanks_note" cols="80" rows="15" ><?php echo $thanks_note; ?></textarea>
            </tr>
          </table>
        </div>
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            <tr>
              <td><?php echo $lang->get("entry_payment_method"); ?></td>
              <td><input type="text" name="payment_method" value="<?php echo $payment_method; ?>" />
            </tr>
            <tr>
              <td><?php echo $lang->get("entry_payment_info"); ?></td>
              <td><input type="text" name="payment_info" value="<?php echo $payment_info; ?>" />
            </tr>
            <tr>
              <td><?php echo $lang->get('entry_payment_notifications'); ?></td>
              <td>
                <table>
                  <?php foreach ($payment_notifications as $pn) { ?>
                    <tr>
                      <td><?php echo $lang->get("entry_notification_method"); ?></td>
                      <td><?php echo $pn['notification_method']; ?></td>
                    </tr>
                    <tr>
                      <td><?php echo $lang->get("entry_notification_contact"); ?></td>
                      <td><?php echo $pn['notification_contact']; ?></td>
                    </tr>
                    <tr>
                      <td><?php echo $lang->get("entry_notification_content"); ?></td>
                      <td><?php echo $pn['notification_content']; ?></td>
                    </tr>
                  <?php } ?>
                </table>
              </td>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" readonly="1" style="background-color:#bbbbbb" name="recipient_address[name]" value="<?php echo isset($recipient_address['name']) ? $recipient_address['name']:'' ; ?>" />
            </tr>
            <tr>
              <td></span> <?php echo $entry_address_1; ?></td>
              <td><input type="text" readonly="1" style="background-color:#bbbbbb" name="recipient_address[address_1]" value="<?php echo isset($recipient_address['address_1']) ? $recipient_address['address_1']:''; ?>" />
            </tr>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <td>物流费用</td>
              <td><input type="text" name="shipping_cost" value="<?php echo $shipping_cost; ?>" />
            </tr>
            <tr>
              <td>物流历史记录</td>
              <td>
        ...
        <div id="tab-card" class="vtabs-content">
          <table class="list">
            <tr>
              <td><?php echo $lang->get('entry_card_id'); ?></td>
              <td><input type="text" name="card_id" value="<?php echo $card_id; ?>" /> </td>
            </tr>
            <tr>
              <td><?php echo $lang->get('entry_card_salutation'); ?></td>
              <td><input type="text" name="order_card_content[salutation]" value="<?php echo isset($order_card_content['salutation'])?$order_card_content['salutation']:''; ?>" /> </td>
            </tr>
            <tr>
              <td><?php echo $lang->get('entry_card_recipient_name'); ?></td>
              <td><input type="text" name="order_card_content[recipient_name]" value="<?php echo isset($order_card_content['recipient_name'])?$order_card_content['recipient_name']:'' ; ?>" /> </td>
            </tr>
            <tr>
              <td><?php echo $lang->get('entry_card_body'); ?></td>
              <td><input type="text" name="order_card_content[body]" value="<?php echo isset($order_card_content['body'])?$order_card_content['body']:''; ?>" /> </td>
            </tr>
            <tr>
              <td><?php echo $lang->get('entry_card_closing'); ?></td>
              <td><input type="text" name="order_card_content[closing]" value="<?php echo isset($order_card_content['closing'])?$order_card_content['closing']:"" ; ?>" /> </td>
            </tr>
          </table>
        </div>        
        <div id="tab-product" class="vtabs-content">
          <table class="list">
            ...
            <tr>
              <td>产品组ID</td>
              <td><?php echo $product_group_id; ?></a></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>原产品</td>
              <td><a href="<?php echo $flavor_product_edit_link; ?>" target="_blank" ><?php echo $flavor_product_id; ?></a> </td>
            </tr>
            <tr>
              <td>原产品组ID</td>
              <td><?php echo $flavor_product_group_id; ?></a></td>
            </tr>
