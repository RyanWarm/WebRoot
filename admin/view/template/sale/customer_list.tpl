          ...
          <tbody>
            <tr class="filter">
              ...
              <td><select name="filter_customer_group_id">
                  ...
                  <?php if ($customer_group['network'] == $filter_customer_group_id) { ?>
                  <option value="<?php echo $customer_group['network']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $customer_group['network']; ?>"><?php echo $customer_group['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select></td>
            ...
            <tr>
              ...
              <td class="left"><?php echo $customer['network_name']; ?></td>
              <td class="left"><?php if($customer['status'] == '1') {echo $male;} else {echo $female;} ?></td>
              <td class="left"><?php echo $customer['approved']; ?></td>
              <td class="left"><?php echo $customer['date_added']; ?></td>
              <td class="left"><img src="<?php echo $customer['image']; ?>"/></td>
