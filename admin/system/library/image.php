...
class Image {
    ...
    public function resize($width = 0, $height = 0, $only_downscale = false) {
    ...
    public function resize_no_fill($width = 0, $height = 0, $only_downscale = false) {
    	if (!$this->info['width'] || !$this->info['height']) {
			return;
		}
